...
return [
     ...
     */
    'environment'       => env('PAYPAL_MASS_MODE', ''),
    ...
    'sandbox' => [
		        ...
		        'api_username'    => env('PAYPAL_MASS_API_USERNAME', ''),

		        'api_password'    => env('PAYPAL_MASS_API_PASSWORD', ''),
                ...
                */
                 ...
                 * If you set authentication as 'api_signature' then you must enter 'api_signature' here
                 */
		        'api_signature'   => env('PAYPAL_MASS_API_SECRET', ''),
	   ],
