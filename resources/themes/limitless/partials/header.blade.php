<!-- Main navbar -->
<div class="navbar navbar-inverse" @if(isset($agent_theme) && !empty($agent_theme['colour_1'])) style="background: {{$agent_theme['colour_1']}}"@endif>
        ...
        <a class="navbar-brand logo" href="{{ $dashboard_route }}">
            <div class="logo-middle">
                ...
                @if(isset($agent_theme) && !empty($agent_theme['logo']))
                    <img src="/{{$agent_theme['logo']}}" alt="Life Process Program" width="100px">
                @else
