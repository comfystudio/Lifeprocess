...
<html lang="en">
    ...
    <body class="sidebar-opposite-visible">
        @if(isset($agent_theme) && !empty($agent_theme))
            <div id="agent_theme" style="display: none;" data-colour_3="{{$agent_theme['colour_3']}}" data-colour_4="{{$agent_theme['colour_4']}}"></div>
        @endif
        <div class="app">
            <div id="content" class="app-content" role="main">
                <div class="box">
                    @include('limitless.partials.header')
                    <div class="col-sm-12 notifications-wrapper sub_header" @if(isset($agent_theme) && !empty($agent_theme['colour_2'])) style="background: {{$agent_theme['colour_2']}}"@endif>
            ...
            $(document).ready(function() {
                ...
                setTimeout(function () {
                   if($('#agent_theme').length){
                       ...
                       $('.panel-heading').css('background', colour_3);
                       $('.admin-bg').css('background', colour_4);
                       $('.coach-bg').css('background', colour_4);
                   }else{
                       $('.panel-heading').css('background', '#E7F4FD');
                       $('.coach-bg').css('background', '#4ea2e2');
                   }
                }, 100);
            });
