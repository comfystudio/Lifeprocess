...
<html lang="en">
    ...
    <body class="sidebar-opposite-visible" @if(isset($agent_theme) && !empty($agent_theme['colour_4'])) style="background: {{$agent_theme['colour_4']}}"@endif>
        @if(isset($agent_theme) && !empty($agent_theme))
            <div id="agent_theme" style="display: none;" data-colour_1="{{$agent_theme['colour_1']}}" data-colour_2="{{$agent_theme['colour_2']}}" data-colour_3="{{$agent_theme['colour_3']}}" data-colour_4="{{$agent_theme['colour_4']}}"></div>
        @endif
        <div class="app">
        ...
        jQuery(document).ready(function() {
            ...
            setTimeout(function () {
               if($('#agent_theme').length){
                   var colour_3 = $('#agent_theme').attr('data-colour_3');
                   var colour_4 = $('#agent_theme').attr('data-colour_4');

                   $('.tab-title h1').css('background', colour_3);
                   $('.panel-heading.active').css('background', colour_3);
               }else{
                   $('.tab-title h1').css('background', '#E7F4FD');
               }
            }, 100);
        });
        </script>
