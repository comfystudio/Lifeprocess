...
@section('content')
<div class="row">
    {!! Form::open(array('route' => 'programs.store','class'=>'form-horizontal','role'=>"form",'id'=>'programs_create_form', 'files' => true)) !!}
        {{Form::hidden('_url',request()->get('_url', request()->getRequestUri()))}}
    <div class="col-md-12">
       <div class="panel panel-white">
            <div class="panel-heading">
                <div class="col-sm-9">
                    <h3 class="panel-title"> {{ trans('comman.addprogram') }} </h3>
                </div>
