...
@section('content')
	<div class="row">
     {!! Form::open(array('route' =>  ['coaches.note', 'id' => $id],'class'=>'form-horizontal','role'=>"form",'id'=>'admin_note',)) !!}
		 <div class="col-md-12">
       		<div class="panel panel-white">
                <div class="panel-heading">
                    <div class="col-sm-12">
                        <div class="col-md-8">
                            <h5 class="panel-title">{{ trans('comman.admin_note') }}</h5>
                        </div>
                    ...
                    <div class="clearfix"></div>
               			...
               			<div class="panel-body">
               				<div class="form-group {{ $errors->has('admin_note') ? 'has-error' : ''}}">
                                                        ...
                                                        <div class="col-sm-7">
                                                            {!! Form::textarea('admin_note', null, ['class' => 'form-control','placeholder' => trans("comman.note"),'rows' => '5']) !!}
                   			...
                   			<div class="form-group">
                		                <div class="col-sm-6 text-right">
                		                    ...
                		                    {!! link_to('coaches', "Cancel",array('class' => 'btn btn-warning cancel')) !!}
                		                </div>
                        	       </div>
            		</div>
