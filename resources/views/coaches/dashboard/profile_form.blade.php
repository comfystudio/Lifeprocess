...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('timezone') ? 'has-error' : ''}}">
            ...
            <div class="col-sm-8">
               {!! Form::text('timezone', null, ['class' => 'form-control','placeholder'=> 'First name', 'id' => 'first_name','readonly']) !!}
...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group {{ $errors->has('welcome_message') ? 'has-error' : ''}}">
            {!! Html::decode(Form::label('welcome_message', trans('comman.welcome_message'). ': ', ['class' => 'control-label col-md-12'])) !!}
            <div class="col-md-12">
                {!! Form::textarea('welcome_message', null, ['class' => 'form-control','placeholder'=> trans('comman.welcome_message'), 'id' => 'welcome_message', 'rows' => '6']) !!}
                {!! ($errors->has('welcome_message') ? $errors->first('welcome_message', '<p class="text-danger">:message</p>') : '') !!}
            </div>
        </div>
    </div>
</div>
