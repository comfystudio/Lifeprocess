    ...
    <div class="panel-body">
        ...
        @foreach($sub_questions AS $sub_question)
            ...
            <div class="row">
                <div class="panel-body" style="padding-left: 15px;">
                    ...
                    <div class="" style="margin: 10px; color: #037AD5;">
                        <div class="panel-body" style="padding: 10px;">
                            <strong>Coach's Response: </strong> <br>
            ...
            @if(isset($sub_question->sub_questions) && count($sub_question->sub_questions) > 0)
                @include('coaches.dashboard.client_detail.download_client_feedback_subQuestions',['sub_questions' => $sub_question->sub_questions, 'parent_question_no' => $parent_question_no . '.' . $sub_question->question_no, 'level' => $level+1])
            @endif
        @endforeach
