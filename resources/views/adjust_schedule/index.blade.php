...
<div class="content-wrapper">
    ...
    <div class="panel-heading">
            <h3 class="panel-title">Adjust Schedules</h3>
        </div>
      <div class="content-wrapper">
        ...
        <div class="panel-body">
          ...
          <br>
            <button id="btn_save" class="btn bg-success btn-labeled heading-btn pull-right"><b><i class="icon-diff-added"></i></b>Save Adjustments</button>
          </div>
  ...
  jQuery(document).ready(function() {
    ...
    jQuery('#calendar').fullCalendar({
      ...
      select: function(start, end) {
        if(start.format('YYYY/MM/DD HH:mm:ss') <= ($('#calendar').fullCalendar('getDate').format('YYYY/MM/DD HH:mm:ss')))
        {
                // console.log(start.format('YYYY/MM/DD HH:mm:ss'));
                // console.log($('#calendar').fullCalendar('getDate').format('YYYY/MM/DD HH:mm:ss'));
      ...
      eventClick: function (event) {
                if(event.start.format('YYYY/MM/DD HH:mm:ss') < ($('#calendar').fullCalendar('getDate').format('YYYY/MM/DD HH:mm:ss')))
                {
       ...
       events: [
        @foreach($schedule as $data)
          ...
          @else
              ...
              // add condition for  remove slot available after week set
                @if($data->start_datetime >= Carbon\Carbon::createFromFormat('Y-m-d H:i:s',Carbon\Carbon::now($coach_timezone)))
                {
                  title: 'Available',
                  start: '{{$data->start_datetime}}',
                  end:'{{$data->end_datetime}}',
