...
<div class="content-wrapper">
    ...
    <div class="panel-heading">
            <h3 class="panel-title">Gratuate 20 minutes Session</h3>
        </div>
      <div class="content-wrapper">
      ...
      eventClick: function (event) {
       ...
       events: [
        @foreach($schedule as $data)
          @if($data->CoachGratuateSessionBooked != null)
                        @if($data->CoachGratuateSessionBooked->session_status == 'cancelled')
                            {
                                title: 'Cancelled',
      ...
      jQuery('#btn_save').click(function() {
        ...
        jQuery('#calendar').fullCalendar('clientEvents', function(event) {
          ...
          if(id == null )
          {
            jQuery.ajax({
                           type: "POST",
                           url: "{{ route('gratuate_session.store') }}",
