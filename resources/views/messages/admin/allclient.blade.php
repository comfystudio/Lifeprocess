                                ...
                                <div class="panel panel-default no-border">
                                    <div class="panel-heading no-border">
                                        <h5 class="panel-title">
                                            Your conversation with {{$all_client[0]['name']}}
                                        </h5>
                                    </div>
                                    <div class="panel-body no-padding">
                                    <div class="tab-pane fade fade active in" id="{{$all_client[0]['id']}}">
                                        <div class="message-listing">
                                        <div class="row no-margin left">
                                            <div class="msg" id="chat" style="">
                                            @foreach($messages as $message)
                                                @if($message->receive_user_id == $all_client[0]['id'] || $message->create_user_id == $all_client[0]['id'])
                                                    {{-- <li class="media date-step content-divider"><span></span></li> --}}
                                                    @if($message->create_user_id != Auth::id())
                                                        <div class="row no-margin left">
                                                            @if(isset($all_client[0]['image']) && !empty($all_client[0]['image']))
                                                                {{Html::image(AppHelper::path('uploads/user/')->size('36x36')->getImageUrl($all_client[0]['image']),'User Photo',array("class"=>"pull-left logo"))}}
                                                            @else
                                        ...
                                        {!! Form::open(array('route' =>  ['messages.save', 'id' => Crypt::encryptString($all_client[0]['id'])],'class'=>'form-horizontal send-msg','role'=>"form",'files' => true)) !!}
