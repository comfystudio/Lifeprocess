...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12">
            {!! Form::model($module_exercise, ['method' => 'PATCH','route' => ['module_exercise.update', 'program_id' => Crypt::encryptString($program_id) ,'module_id' => Crypt::encryptString($module_id), Crypt::encryptString($module_exercise->id)],'class' => 'form-horizontal', 'files' => true]) !!}
            {{Form::hidden('_edit_url',request()->getRequestUri())}}
            {{Form::hidden('_url',request()->get('_url'))}}
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h3 class="panel-title">{{trans('comman.edit')}} {{ trans('comman.module_exercise') }}</h3>
