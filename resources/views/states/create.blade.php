...
@section('content')
<div class="row">
    {!! Form::open(array('route' => 'states.store','class'=>'form-horizontal','role'=>"form",'id'=>'state_create_form')) !!}
    <div class="col-md-12">
       <div class="panel panel-white">
            <div class="panel-heading">
                <div class="col-sm-9"><h5 class="panel-title">{{trans('comman.addstate')}}</h5></div>
