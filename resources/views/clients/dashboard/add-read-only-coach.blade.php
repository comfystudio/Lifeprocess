    ...
    <div class="tab-pane fade in active">
        <div class="col-md-12">
            ...
            <form accept-charset="UTF-8" method="post" action="/client/add-read-only-coach" autocomplete="off" class ='form-horizontal'>
                ...
                <div class="tab-title">
                    <h1 class="no-margin">Invite Coach</h1>
                </div>
                    ...
                    <div class="brd">
                        <div class="firstDiv">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group {{ $errors->has('invite_coach') ? 'has-error' : ''}}">
                                        {!! Html::decode(Form::label('invite_coach', 'Email:<span class="has-stik">*</span>', ['class' => 'col-sm-12 '])) !!}
                                        <div class="col-sm-12">
                                            {!! Form::text('invite_coach', null, ['class' => 'form-control','placeholder'=>'Email', 'id' => 'email']) !!}
                                            {!! ($errors->has('invite_coach') ? $errors->first('invite_coach', '<p class="text-danger">:message</p>') : '') !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
