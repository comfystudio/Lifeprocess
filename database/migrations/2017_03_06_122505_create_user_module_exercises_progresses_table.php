...
class CreateUserModuleExercisesProgressesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_module_exercises_progresses', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('user_module_exercises_progresses');
    }
}
