...
class CreateGratuateUnloackModules extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gratuate_module_progresses', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('gratuate_module_progresses');
    }
}
